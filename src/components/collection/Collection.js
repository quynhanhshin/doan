            ...
            <Row>
                <Col sm={12} lg={6}>
                    <Card>
                        <img src={pic01} />
                        <CardBody>
                            <CardTitle className="title-collection" tag="h5">
                                Best baby environment setting
                            </CardTitle>
                            <CardText className="text-collection">Metus aliquam eleifend mi in nulla cras sedo fel.</CardText>
                            <CardLink className="btn-collection" href="#">
                                VIEW COLLECTION
                            </CardLink>
                        </CardBody>
                        <div className="product-collection-1">
                            ...
                            <Card className="card-product-collection-1">
                                ...
                                <div className="btn-read-more">
                                    <span className="read-more-collection" tag="h6">
                                        READ MORE
                                    </span>
                                    <span className="icon-btn-read-more">
                ...
                <Col sm={12} lg={6}>
                    <Card>
                        ...
                        <CardBody>
                            <CardTitle className="title-collection" tag="h5">
                                Make a dreamy nursery
                            </CardTitle>
                            <CardText className="text-collection">Convallis a cras semper auctor neque vita teme.</CardText>
                            <CardLink className="btn-collection" href="#">
                                VIEW COLLECTION
                            </CardLink>
                        </CardBody>
